...
def compatibility_exec_repl(year, month, day, last, middle, first):
    # determines compatibility based on either life path number or expression number; however, since the calculations of these numbers are buried in the birthday and name menus, need to recompute those here
