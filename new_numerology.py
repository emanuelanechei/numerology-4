...
life_path_calc(single_year_master, single_month_master, single_day_master)
...
birth_day_calc(single_day_master)
...
first_chall_calc(single_day_uno, single_month_uno)
...
sec_chall_calc(single_day_uno, single_year_uno)
...
third_chall_calc(first_chall, sec_chall)
...
fourth_chall_calc(single_month_uno, single_year_uno)
...
def pers_year_calc(single_day_uno, single_month_uno, single_year_uno, month, day):
    ...
    #if personal_year == 1:
        #print """The first of the 9 year cycle, a """
    return personal_year

pers_year_calc(single_day_uno, single_month_uno, single_year_uno, month, day)
